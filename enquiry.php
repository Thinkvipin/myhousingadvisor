...
if(isset($_POST['header'])){
 ...
 $h="smtpout.secureserver.net";  //----host
  ...
  $sub="My Housing Advisor - General ";
  ...
  $mail->FromName = "MyHousing Advisor Team";
...
<head>
  <meta charset="utf-8">
  <title>My Housing Advisor</title>
...
<body>
  <div class='container'>
    ...
    <center>
      <img src='https://www.myhousingadvisor.com/images/Myhousingadvisor.png' alt='logo' style="width: 200px;">
    </center> 
    <br>
    <center><h2 class='text-center'>Thanks for showing interest. <br>Your Housing Advisor will shortly assist you with the details of <b>Projects</b>.<br>You may also contact us on <a href="tel:+917838213540">+91 7838213540 </a></h2>
    </center>
    <br>
    <center>
      ...
      <br>
      <br>
      <a href="https://www.myhousingadvisor.com" class="home-link">Back to Home</a>
    </center>
