...
if(isset($_POST['header'])){
 ...
 $h="smtpout.secureserver.net";  //----host
  ...
  $sub="My Housing Advisor - Godrej Palm Retreat at Sector 150, Noida ";
  ...
  $mail->FromName = "Godrej Palm Retreat at Sector 150, Noida Team";
...
<head>
  <meta charset="utf-8">
  <title>Godrej Palm Retreat at Sector 150, Noida</title>
...
<body>
  <div class='container'>
    ...
    <center>
      <img src='img/godrej.png' alt='logo' style="padding-top: 105px;    width: 280px;">
    </center> 
    <br>
    <center><h2 class='text-center'>Thanks for showing interest. <br>Your Housing Advisor will shortly assist you with the details of <b>Godrej Palm Retreat at Sector 150, Noidas</b>.<br>You may also contact us on <a href="tel:+917838213540">+91 7838213540 </a></h2>
    </center>
    <br>
    <center>
    
      <a href="Godrej_Palm_Retreat_--_Overview.pdf" target="_blank" class="btn btn-primary">DOWNLOAD BROCHURE</a>
      <br>
      <br>
      <a href="https://www.myhousingadvisor.com/godrej/index.php" class="home-link">Back to Home</a>
    </center>
