...
if(isset($_POST['header'])){
 ...
 $h="smtpout.secureserver.net";  //----host
  ...
  $sub="My Housing Advisor - Rise Resort Residences";
  ...
  $mail->FromName = "Rise Resort Villa";
...
<head>
  <meta charset="utf-8">
  <title>The Rise Resort Residences </title>
  <link href="https://www.myhousingadvisor.com/images/favicon.png" rel="icon" type="image/x-icon">
...
<body>
  <div class='container'>
    ...
    <center>
      <img src='https://www.riseresortresidences.myhousingadvisor.com/img/rise-resort-logo.png' alt='logo'>
    </center> 
    <br>
    <center><h2 class='text-center'>Thanks for showing interest. <br>Your Housing Advisor will shortly assist you with the details of <b>Rise Resort Villas</b>.<br>You may also contact us on <a href="tel:+917838213540">+91 7838213540 </a></h2>
    </center>
    <br>
    <center>
    
      <a href="https://www.riseresortresidences.myhousingadvisor.com/Brochure.pdf" target="_blank" class="btn btn-primary">DOWNLOAD BROCHURE</a>
      <br>
      <br>
      <a href="https://www.riseresortresidences.myhousingadvisor.com" class="home-link">Back to Home</a>
    </center>
